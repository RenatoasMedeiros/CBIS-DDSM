...
LEARNING_RATE = 0.01 # A higher learning rate is often better for training from scratch
RANDOM_STATE = 42
PATIENCE_EARLY_STOPPING = 15
PATIENCE_REDUCE_LR = 7

OUTPUT_DIR = os.path.join('./', f"run_{MODEL_NAME}_{IMG_WIDTH}_{BATCH_SIZE}_BC_A_No_DataAugmentation_{datetime.now().strftime('%Y%m%d_%H%M%S')}")
