...
MODEL_NAME = 'EfficientNetB7_Binary'
...
OUTPUT_DIR = os.path.join('./', f"run_{MODEL_NAME}_{IMG_WIDTH}_{BATCH_SIZE}_512_256_128_{datetime.now().strftime('%Y%m%d_%H%M%S')}")
...
x = Dropout(0.3, name="top_dropout_3")(x)
x = Dense(128, activation='relu', name="dense_128")(x)
x = Dropout(0.2, name="top_dropout_4")(x)
...
# Unfreeze layers from a certain block onwards in EfficientNetB7
# EfficientNetB7 has blocks named 'block2a_expand_conv', 'block3a_expand_conv', ..., 'block7a_expand_conv'
